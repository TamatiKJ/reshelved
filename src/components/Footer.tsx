...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#121212] text-white mt-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-end">
          <div>
            <Link to="/" className="inline-flex items-center" aria-label="Reshelved home">
              <img src="/reshelved-logo-white.svg" alt="Reshelved" className="h-auto w-[60%] max-w-[180px] sm:h-7 sm:w-auto sm:max-w-none" />
            </Link>
