...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white pt-0 pb-16 overflow-hidden"><div className="max-w-7xl mx-auto px-4 sm:px-6"><picture><source media="(max-width: 767px)" srcSet="/homepage personas active mobile.webp" /><img src="/homepage personas active.webp" alt="Different types of Reshelved readers and book traders" className="w-full h-auto block -my-6 sm:my-0" loading="lazy" /></picture></div></section>
