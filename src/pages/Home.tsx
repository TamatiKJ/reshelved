      ...
      <section className="bg-[#121212] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-[116px] sm:pt-32 sm:pb-[148px]">
          <div className="max-w-3xl">
            <h1 className="text-5xl sm:text-7xl font-bold leading-[1.08] tracking-tight">Find the Books You Need Without Paying Full Price</h1>
            <p className="mt-8 text-xl text-white/85 leading-relaxed max-w-2xl">Reshelved helps you search affordable physical books by title, author, genre, academic field, condition, and location — all in one platform.</p>
            <div className="mt-9 flex flex-wrap gap-3"><Link to="/browse" className="inline-flex items-center justify-center px-5 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-md transition">Start Finding Books</Link><Link to="/create" className="inline-flex items-center justify-center px-5 py-3 text-white font-semibold rounded-md border border-white/70 hover:bg-white hover:text-stone-950 transition">List a Book <i className="las la-angle-right ml-1" /></Link></div>
          </div>
        </div>
      </section>
