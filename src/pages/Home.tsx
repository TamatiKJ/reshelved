...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="relative bg-[#121212] bg-[url('/woman%20reading%20hero%20image.png')] bg-cover bg-center bg-no-repeat text-white"><div className="absolute inset-0 bg-black/45" /><div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-[116px] sm:pt-32 sm:pb-[148px]"><div className="max-w-3xl"><h1 className="text-5xl sm:text-7xl font-bold leading-[1.08] tracking-tight">Reshelved Finds The Books You Need For Less</h1><p className="mt-8 text-xl text-white/85 leading-relaxed max-w-2xl">Reshelved helps you find affordable physical books by title, author, genre, condition, and location in one simple platform.</p><div className="mt-9 flex flex-wrap gap-3"><Link to="/browse" className="inline-flex items-center justify-center px-5 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-md transition">Start Finding Books</Link><Link to="/create" className="inline-flex items-center justify-center px-5 py-3 text-white font-semibold rounded-md border border-white/70 hover:bg-white hover:text-stone-950 transition">List a Book <i className="las la-angle-right ml-1" /></Link></div></div></div></section>
