        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-[116px] sm:pt-32 sm:pb-[148px]">
          <div className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <Link
                to="/browse"
                className="inline-flex items-center justify-center px-5 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-md transition"
              >
                Start Finding Books
              </Link>
              <Link
                to="/create"
                className="inline-flex items-center justify-center px-5 py-3 text-white font-semibold rounded-md border border-white/70 hover:bg-white hover:text-stone-950 transition"
              >
      ...
      <section className="relative -mt-[60px] bg-white rounded-t-[42px] sm:rounded-t-[56px] pt-12 pb-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-stretch">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full h-12 pl-12 pr-4 rounded-lg border border-stone-200 text-sm focus:outline-none focus:border-[#1665CC] focus:ring-2 focus:ring-[#1665CC]/10"
              />
            </div>
            {showingSearch && (
              <button
          ...
          {loading ? (
            ...
            <div className="mt-6 rounded-3xl border border-stone-200 bg-stone-50 px-6 py-12 text-center">
              ...
              <h3 className="mt-3 text-xl font-bold text-stone-900">
                We didn't find that title or author. Try another search
              </h3>
            </div>
          ) : (
            <div className="mt-6 rounded-3xl border border-stone-200 bg-stone-50 px-6 py-12 text-center">
              ...
              <Link
                to="/create"
                className="mt-5 inline-flex px-5 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-md transition"
              >
                List the first book
              </Link>
            </div>
          ...
          <div className="mt-20 pb-4">
            ...
            <p className="text-center text-xs font-semibold text-stone-400 mt-3">
              Collections from Top Publishers
            </p>
      ...
      <section id="how-it-works" className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-xl">
            ...
            <Link
              to="/browse"
              className="mt-8 inline-flex px-5 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-md transition"
            >
              Start Finding Books
            </Link>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="relative mt-10 mb-10 sm:mb-0 -mx-4 sm:mx-0">
            ...
            <div
              ...
              className="flex gap-4 overflow-x-auto px-4 pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:grid sm:grid-cols-2 sm:gap-5 sm:overflow-visible sm:px-0 sm:pb-0 lg:grid-cols-6"
            >
              {bookCategoryCards.map((category) => (
                <Link
                  key={category.title}
                  to={category.href}
                  className="group w-[calc((100vw-64px)/2.5)] min-w-[calc((100vw-64px)/2.5)] rounded-[22px] border border-stone-200 bg-white p-4 min-h-[180px] flex flex-col justify-between hover:-translate-y-1 hover:shadow-xl hover:border-primary-600 transition-all duration-300 sm:w-auto sm:min-w-0 sm:p-5 sm:min-h-[190px]"
                >
                  <h3 className="text-[19px] sm:text-[21px] leading-tight font-semibold text-stone-900">
                    {category.title}
                  </h3>
                  <div className="mt-4 flex items-center justify-center">
                    <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl flex items-center justify-center">
                      <span
                        className="flex h-[60px] items-center justify-center text-[60px] leading-none"
                        role="img"
      ...
      <section className="relative bg-[#121212] text-white pt-0 pb-0">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 -translate-y-1/2 mb-[-100px] sm:mb-[-120px] relative z-10">
          <div className="bg-[#FFF4E2] text-stone-950 rounded-[28px] sm:rounded-[36px] px-6 sm:px-16 py-16 sm:py-24 text-center">
            ...
            <div className="mt-5 sm:mt-6 flex flex-wrap justify-center gap-3">
              <Link
                to="/create"
                className="px-5 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-md transition"
              >
                List a Book
              </Link>
              <Link
                to="/browse"
                className="px-5 py-3 border border-stone-900 text-stone-900 font-semibold rounded-md hover:bg-stone-900 hover:text-white transition"
              >
                Find Books
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-0 pt-0">
          <div className="text-center">
            <p className="text-xs font-bold tracking-[0.25em] text-white uppercase mb-4">
              LOVED ACROSS NAIROBI
            </p>
            <h2 className="text-4xl sm:text-6xl font-bold">
              200+ Nairobians are exchanging books and saving money
            </h2>
          </div>
